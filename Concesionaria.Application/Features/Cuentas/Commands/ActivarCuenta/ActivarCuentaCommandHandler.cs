...
public class ActivarCuentaCommandHandler
    : IRequestHandler<ActivarCuentaCommand, Unit>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUser;

    public ActivarCuentaCommandHandler(
