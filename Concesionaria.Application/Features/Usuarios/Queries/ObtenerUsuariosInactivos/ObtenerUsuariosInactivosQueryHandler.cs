...
public class ObtenerUsuariosInactivosQueryHandler
    : IRequestHandler<ObtenerUsuariosInactivosQuery, List<UsuarioDto>>
{
    private readonly IUsuarioRepository _repository;
    private readonly ICurrentUserService _currentUser;

    public ObtenerUsuariosInactivosQueryHandler(
    ...
    public async Task<List<UsuarioDto>> Handle(
        ObtenerUsuariosInactivosQuery request,
        CancellationToken cancellationToken
    )
    {
        var usuarios = await _repository.ObtenerInactivosAsync(
