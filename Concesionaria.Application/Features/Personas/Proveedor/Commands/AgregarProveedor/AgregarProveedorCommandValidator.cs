...
public class AgregarProveedorCommandValidator : AbstractValidator<AgregarProveedorCommand>
{
    public AgregarProveedorCommandValidator(
        ...
        RuleFor(c => c.Cuil)
            ...
            .CustomAsync(
                async (cuil, context, ct) =>
                {
                    ...
                    var estado = await repository.ExistePorCuilAsync(cuil.Trim(), empresaId);
