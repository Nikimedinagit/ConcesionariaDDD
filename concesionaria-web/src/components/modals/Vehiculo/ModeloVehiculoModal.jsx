...
import { modeloVehiculoSchema } from "@/validations/Vehiculo/modeloVehiculo.validation";

export function ModeloVehiculoModal({
  isOpen,
  onClose,
  onSave,
  modelo = null,
  ...
  const handleSave = () => {
    const result = modeloVehiculoSchema.safeParse({
      nombre,
      marcaVehiculoId,
      tipoVehiculoId,
    });
    ...
    setErrors({});
    onSave({
      modeloVehiculoId: modelo?.modeloVehiculoId,
      ...result.data,
    ...
    >
      <div className="space-y-4">
        <AppInput
          ...
          error={errors.nombre?.[0] || serverError}
          autoFocus
        />
        <AppSearchSelect
          label="Marca *"
          ...
          onValueChange={(value) => {
            setMarcaVehiculoId(value);
            clearError("marcaVehiculoId");
          }}
          options={marcas}
          optionValue="marcaVehiculoId"
          optionLabel="nombre"
          placeholder="Seleccione una marca"
          searchPlaceholder="Buscar marca..."
          error={errors.marcaVehiculoId?.[0]}
        />
        <AppSearchSelect
          ...
          onValueChange={(value) => {
            ...
            clearError("tipoVehiculoId");
          }}
          options={tiposVehiculos}
          optionValue="tipoVehiculoId"
          optionLabel="nombre"
          placeholder="Seleccione un tipo"
          searchPlaceholder="Buscar tipo..."
          error={errors.tipoVehiculoId?.[0]}
        />
      </div>
    </ModalCustom>
  );
