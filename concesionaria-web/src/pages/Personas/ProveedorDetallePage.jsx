...
import { AtSign, ContactRound, MapPin, MapPinned, Phone, Wrench } from "lucide-react";
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 text-slate-600 shadow-sm">
          No se encontró la información del proveedor. Volvé al listado para seleccionarlo nuevamente.
          <BackButton className="mt-4" onClick={() => navigate("/layout/proveedores")}>Volver a proveedores</BackButton>
        </div>
      </div>
    );
  }
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-[0_3px_12px_rgba(15,23,42,0.06)] sm:p-5">
        <div className="mb-4 flex items-center justify-between border-b border-slate-100 pb-3">
          <div>
            ...
            <h2 className="mt-0.5 text-base font-bold uppercase tracking-wide text-slate-800">{proveedor.nombre}</h2>
          </div>
